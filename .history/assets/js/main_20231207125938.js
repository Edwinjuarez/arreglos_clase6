...
console.log("el nombre es:",concatenacionString(nombre , apellido ));

var nombre = "ingenio";
var apellido = "la union";
console.log(nombre + " " + apellido);
//esta es la funcion del nombre de arriba para concatenar String.
function concatenarString (string20 , string40) {
    return string20 + " " + string40;
}
console.log("el nombre completo de la empresa es:",concatenarString(nombre , apellido));

arreglos_nombres.push("Diego"); //se necesitan PARENTECIS PARA AGREGAR UN NOMBRE NO CORCHETES[]
console.table(arreglos_nombres);

arreglos_nombres.pop("Diego");
console.table(arreglos_nombres);

let arreglo_string =["Edvin", "josue", "ezequiel", "isaac", "ingrid", "mala pata", "caballo", ];
console.table("este es mi primer arreglo script", arreglo_string [2]);

var nombre = "edvin";
var Apellido = "juarez";

function nombreCombleto (nombre1 , nombre2) {
    return nombre1 + " " + nombre2;
    
}
console.log(nombreCombleto (nombre1 ,Apellido));