...
// Arreglos_nombres.push("diego"); //nos permite agregar nombre al final de cada arreglo..

// Arreglos_nombres.push("tania");
// Arreglos_nombres.push("maria cristina");
// console.table(Arreglos_nombres);

// Arreglos_nombres.unshift("alexis"); //nos agrega un nombre al principio de  cada arreglo..
Arreglos_nombres.pop();
Arreglos_nombres.shift();
console.table(Arreglos_nombres);
console.log("nos imprime el largo de nuestro arreglo", Arreglos_nombres.length);
